...
"count($self, substring, start=0, end=sys.maxsize, /)\n"
"--\n"
"\n"
...
static Py_ssize_t
unicode_count_impl(PyObject *self, const char *substring, Py_ssize_t start,
                   Py_ssize_t end);
...
skip_optional:
    _return_value = unicode_count_impl(self, substring, start, end);
...
"index($self, substring, start=0, end=sys.maxsize, /)\n"
"--\n"
"\n"
"Return the lowest index in a string where substring is found.\n"
"\n"
...
skip_optional:
    _return_value = unicode_index_impl(self, substring, start, end);
    if ((_return_value == -1) && PyErr_Occurred()) {
        goto exit;
    }
    return_value = PyLong_FromSsize_t(_return_value);
...
"rfind($self, substring, start=0, end=sys.maxsize, /)\n"
"--\n"
"\n"
...
skip_optional:
    _return_value = unicode_rfind_impl(self, substring, start, end);
    if ((_return_value == -1) && PyErr_Occurred()) {
        goto exit;
    }
    return_value = PyLong_FromSsize_t(_return_value);
...
"rindex($self, substring, start=0, end=sys.maxsize, /)\n"
"--\n"
"\n"
"Return the highest index in a string where substring is found.\n"
"\n"
...
skip_optional:
    _return_value = unicode_rindex_impl(self, substring, start, end);
    if ((_return_value == -1) && PyErr_Occurred()) {
        goto exit;
    }
    return_value = PyLong_FromSsize_t(_return_value);
...
skip_optional:
    _return_value = unicode_startswith_impl(self, subobj, start, end);
    if ((_return_value == -1) && PyErr_Occurred()) {
        goto exit;
    }
...
skip_optional:
    _return_value = unicode_endswith_impl(self, subobj, start, end);
    if ((_return_value == -1) && PyErr_Occurred()) {
        goto exit;
    }
    return_value = PyBool_FromLong((long)_return_value);
...
/*[clinic end generated code: output=885630702553333d input=a9049054013a1b77]*/
