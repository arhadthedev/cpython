...
"find($self, subsection, start=0, end=sys.maxsize, /)\n"
"--\n"
"\n"
...
skip_optional:
    return_value = bytes_find_impl(self, subsection, start, end);
...
/*[clinic end generated code: output=ac6557394d74e571 input=a9049054013a1b77]*/
