...
* Add :meth:`~asyncio.streams.StreamWriter.start_tls` method for upgrading
  existing stream-based connections to TLS and
  :meth:`~asyncio.streams.StreamWriter.shutdown_tls` method for downgrading it
  back. (Contributed by Ian Good in :issue:`34975`.)
